...
class AutolabelModel:
    ...
    Attributes:
        ...
        score (float | None, optional): Label score for the annotation from this model (range: 0.0–1.0).
        uncertainty (float | None, optional): Model-reported uncertainty for the annotation.
